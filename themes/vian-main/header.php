    ...
    <div class="container">
      <div class="row align-items-center g-3">
        ...
        <div class="col-6 col-md-2">
          <a class="site-logo d-inline-flex align-items-center" href="<?php echo esc_url(home_url('/')); ?>" aria-label="<?php bloginfo('name'); ?>">
        ...
        <div class="col-6 col-md-3 d-flex justify-content-end align-items-center gap-2 order-2 order-md-3">
          <form role="search" method="get" class="vian-search" action="<?php echo esc_url(home_url('/')); ?>">
            ...
            <input id="s" type="search" name="s" class="form-control form-control-sm vian-search-input" placeholder="<?php esc_attr_e('Tìm kiếm', 'vian'); ?>">
          </form>
